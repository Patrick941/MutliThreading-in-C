...
#define PanSource	"writers-and-reader.pml"
...
#define _nstates1	88	/* consumer */
#define minseq1	88
#define maxseq1	174
#define _endstate1	87

#define _nstates0	89	/* producer */
#define minseq0	0
#define maxseq0	87
#define _endstate0	88
...
struct mutexData { /* user defined type */
	uchar mstate;
	uchar mid;
};
struct condvarData { /* user defined type */
	uchar cstate;
};
...
#define Air2	(sizeof(P2) - Offsetof(P2, z) - 1*sizeof(int))
...
typedef struct State {
	...
	uchar out;
	uchar six;
	struct mutexData mtx;
	struct condvarData cvars[2];
#ifdef TRIX
