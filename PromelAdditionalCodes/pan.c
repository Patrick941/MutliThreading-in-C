/*** Generated by Spin Version 6.5.2 -- 13 October 2022 ***/
/*** From source: pathingTest.pml ***/
...
short src_ln1 [] = {
	  0,  11,  11,  11,  12,  12,  12,  13, 
	 13,  13,  14,  14,  14,  10,  16,  10, 
	 17,  17,  18,  18,  19,  19,  20,  20, 
	 16,  24,  24,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "pathingTest.pml", 1, 26 },
	{ "-", 27, 28 }
};
uchar reached1 [] = {
	  0,   1,   0,   1,   1,   0,   1,   1, 
